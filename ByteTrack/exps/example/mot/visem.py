...
class Exp(MyExp):
    def __init__(self):
        ...
        self.exp_name = os.path.split(os.path.realpath(__file__))[
            1].split(".")[0]
        self.train_ann = "/home/htluc/mediaeval2022_medico/ByteTrack/VISEM_Tracking_Train_v4/annotations/Train.json"
        self.val_ann = "/home/htluc/mediaeval2022_medico/ByteTrack/VISEM_Tracking_Train_v4/annotations/Val.json"
